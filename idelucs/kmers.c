...
#define __PYX_HAVE__idelucs__kmers
#define __PYX_HAVE_API__idelucs__kmers
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'idelucs.kmers' */
...
static void __pyx_f_7idelucs_5kmers_kmer_counts(__Pyx_memviewslice, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_7idelucs_5kmers_cgr(__Pyx_memviewslice, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "idelucs.kmers"
extern int __pyx_module_is_main_idelucs__kmers;
int __pyx_module_is_main_idelucs__kmers = 0;

/* Implementation of 'idelucs.kmers' */
...
static PyObject *__pyx_pf_7idelucs_5kmers_kmer_counts(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_seq, int __pyx_v_k, __Pyx_memviewslice __pyx_v_counts); /* proto */
static PyObject *__pyx_pf_7idelucs_5kmers_2cgr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_seq, int __pyx_v_k, __Pyx_memviewslice __pyx_v_CGR); /* proto */
...
static PyObject *__pyx_pw_7idelucs_5kmers_1kmer_counts(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_7idelucs_5kmers_kmer_counts(__Pyx_memviewslice __pyx_v_seq, int __pyx_v_k, __Pyx_memviewslice __pyx_v_counts, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_k_mer;
  int __pyx_v_bp;
  int __pyx_v_bp_code;
  int __pyx_v_i;
  int __pyx_v_countdown;
  int __pyx_v_contiglength;
  int __pyx_v_size;
  unsigned int *__pyx_v_encoding;
  __Pyx_RefNannyDeclarations
  size_t __pyx_t_1;
  unsigned int __pyx_t_2[256];
  int __pyx_t_3;
  int __pyx_t_4;
  int __pyx_t_5;
  Py_ssize_t __pyx_t_6;
  int __pyx_t_7;
  __Pyx_RefNannySetupContext("kmer_counts", 0);

  /* "idelucs/kmers.pyx":13
 *     """
 * 
 ...
 * 
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_seq); 
  __pyx_v_contiglength = __pyx_t_1;

  /* "idelucs/kmers.pyx":17
 *     cdef int countdown = k-1
 *     cdef int contiglength = len(seq)
 *     cdef int size = (1 << (2 * k)) - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_size = ((1 << (2 * __pyx_v_k)) - 1);

  /* "idelucs/kmers.pyx":19
 *     cdef int size = (1 << (2 * k)) - 1
 * 
 *     cdef unsigned int* encoding = [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,             # <<<<<<<<<<<<<<
 ...
 *         bp_code = encoding[bp]
 */
  __pyx_t_3 = __pyx_v_contiglength;
  __pyx_t_4 = __pyx_t_3;
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    __pyx_v_i = __pyx_t_5;

    /* "idelucs/kmers.pyx":39
 * 
 *     for i in range(contiglength):
 *         bp = seq[i]             # <<<<<<<<<<<<<<
 *         bp_code = encoding[bp]
 ...
 */
    __pyx_t_6 = __pyx_v_i;
    __pyx_v_bp = (*((unsigned char *) ( /* dim=0 */ ((char *) (((unsigned char *) __pyx_v_seq.data) + __pyx_t_6)) )));

    /* "idelucs/kmers.pyx":40
 *     for i in range(contiglength):
 *         bp = seq[i]
 *         bp_code = encoding[bp]             # <<<<<<<<<<<<<<
 * 
 *         if bp_code == 4:
 */
    __pyx_v_bp_code = (__pyx_v_encoding[__pyx_v_bp]);

    /* "idelucs/kmers.pyx":42
 *         bp_code = encoding[bp]
 * 
 *         if bp_code == 4:             # <<<<<<<<<<<<<<
 *             countdown = k
 * 
 */
    __pyx_t_7 = ((__pyx_v_bp_code == 4) != 0);
    if (__pyx_t_7) {

      /* "idelucs/kmers.pyx":43
 * 
 *         if bp_code == 4:
 *             countdown = k             # <<<<<<<<<<<<<<
 * 
 ...
 *         if countdown == 0:
 */
    __pyx_v_k_mer = (((__pyx_v_k_mer << 2) | __pyx_v_bp_code) & __pyx_v_size);

    /* "idelucs/kmers.pyx":47
 *         k_mer = ((k_mer << 2) | bp_code) & size
 * 
 *         if countdown == 0:             # <<<<<<<<<<<<<<
 *             counts[k_mer] += 1
 *         else:
 */
    __pyx_t_7 = ((__pyx_v_countdown == 0) != 0);
    if (__pyx_t_7) {

      /* "idelucs/kmers.pyx":48
 * 
 *         if countdown == 0:
 *             counts[k_mer] += 1             # <<<<<<<<<<<<<<
 *         else:
 *             countdown -= 1
 */
      __pyx_t_1 = __pyx_v_k_mer;
      *((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_counts.data) + __pyx_t_1)) )) += 1;
...
static PyObject *__pyx_pw_7idelucs_5kmers_1kmer_counts(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("kmer_counts (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_seq,&__pyx_n_s_k,&__pyx_n_s_counts,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_k)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("kmer_counts", 1, 3, 3, 1); __PYX_ERR(0, 2, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_counts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("kmer_counts", 1, 3, 3, 2); __PYX_ERR(0, 2, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "kmer_counts") < 0)) __PYX_ERR(0, 2, __pyx_L3_error)
      }
    ...
    __pyx_v_seq = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_seq.memview)) __PYX_ERR(0, 2, __pyx_L3_error)
    __pyx_v_k = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_k == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L3_error)
    __pyx_v_counts = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_counts.memview)) __PYX_ERR(0, 2, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("kmer_counts", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 2, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("idelucs.kmers.kmer_counts", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7idelucs_5kmers_kmer_counts(__pyx_self, __pyx_v_seq, __pyx_v_k, __pyx_v_counts);
...
static PyObject *__pyx_pf_7idelucs_5kmers_kmer_counts(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_seq, int __pyx_v_k, __Pyx_memviewslice __pyx_v_counts) {
  ...
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_7idelucs_5kmers_kmer_counts(__pyx_v_seq, __pyx_v_k, __pyx_v_counts, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
...
static PyObject *__pyx_pw_7idelucs_5kmers_3cgr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_7idelucs_5kmers_cgr(__Pyx_memviewslice __pyx_v_seq, int __pyx_v_k, __Pyx_memviewslice __pyx_v_CGR, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_cgr_i;
  unsigned int __pyx_v_cgr_j;
  int __pyx_v_bp;
  int __pyx_v_i_bit;
  int __pyx_v_j_bit;
  int __pyx_v_n_bp;
  ...
  unsigned int *__pyx_v_i_encoding;
  unsigned int *__pyx_v_j_encoding;
  int __pyx_v_i;
  __Pyx_RefNannyDeclarations
  size_t __pyx_t_1;
  unsigned int __pyx_t_2[256];
  unsigned int __pyx_t_3[256];
  int __pyx_t_4;
  int __pyx_t_5;
  int __pyx_t_6;
  Py_ssize_t __pyx_t_7;
  int __pyx_t_8;
  __Pyx_RefNannySetupContext("cgr", 0);

  /* "idelucs/kmers.pyx":62
 *     """
 * 
 ...
 */
  __pyx_v_size = ((1 << __pyx_v_k) - 1);

  /* "idelucs/kmers.pyx":70
 *     cdef int size = (1 << k) - 1
 * 
 *     cdef unsigned int* i_encoding = [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_2[254] = 2;
  __pyx_t_2[255] = 2;
  __pyx_v_i_encoding = __pyx_t_2;

  /* "idelucs/kmers.pyx":87
 *                                     2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
 * 
 ...
 */
  ...
  __pyx_t_3[254] = 2;
  __pyx_t_3[255] = 2;
  __pyx_v_j_encoding = __pyx_t_3;

  /* "idelucs/kmers.pyx":104
 *                                     2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
 * 
 *     for i in range(contiglength):             # <<<<<<<<<<<<<<
 *         bp = seq[i]
 *         i_bit = i_encoding[bp]
 */
  __pyx_t_4 = __pyx_v_contiglength;
  __pyx_t_5 = __pyx_t_4;
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_i = __pyx_t_6;

    /* "idelucs/kmers.pyx":105
 * 
 *     for i in range(contiglength):
 *         bp = seq[i]             # <<<<<<<<<<<<<<
 *         i_bit = i_encoding[bp]
 ...
 */
    __pyx_t_7 = __pyx_v_i;
    __pyx_v_bp = (*((unsigned char *) ( /* dim=0 */ ((char *) (((unsigned char *) __pyx_v_seq.data) + __pyx_t_7)) )));

    /* "idelucs/kmers.pyx":106
 *     for i in range(contiglength):
 *         bp = seq[i]
 *         i_bit = i_encoding[bp]             # <<<<<<<<<<<<<<
 *         j_bit = j_encoding[bp]
 * 
 */
    __pyx_v_i_bit = (__pyx_v_i_encoding[__pyx_v_bp]);

    /* "idelucs/kmers.pyx":107
 *         bp = seq[i]
 *         i_bit = i_encoding[bp]
 *         j_bit = j_encoding[bp]             # <<<<<<<<<<<<<<
 * 
 *         if i_bit < 2 :
 */
    __pyx_v_j_bit = (__pyx_v_j_encoding[__pyx_v_bp]);

    /* "idelucs/kmers.pyx":109
 *         j_bit = j_encoding[bp]
 * 
 *         if i_bit < 2 :             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_8 = ((__pyx_v_i_bit < 2) != 0);
    if (__pyx_t_8) {

      /* "idelucs/kmers.pyx":110
 * 
 *         if i_bit < 2 :
 *             cgr_i = (i_bit << n_bp | cgr_i) #Move previous kmer, append new one and use the mask to fix kmer-length             # <<<<<<<<<<<<<<
 *             cgr_j = (j_bit << n_bp | cgr_j)
 *             n_bp += 1
 */
      __pyx_v_cgr_i = ((__pyx_v_i_bit << __pyx_v_n_bp) | __pyx_v_cgr_i);

      /* "idelucs/kmers.pyx":111
 *         if i_bit < 2 :
 *             cgr_i = (i_bit << n_bp | cgr_i) #Move previous kmer, append new one and use the mask to fix kmer-length
 *             cgr_j = (j_bit << n_bp | cgr_j)             # <<<<<<<<<<<<<<
 *             n_bp += 1
 *         else:
 */
      __pyx_v_cgr_j = ((__pyx_v_j_bit << __pyx_v_n_bp) | __pyx_v_cgr_j);

      /* "idelucs/kmers.pyx":112
 *             cgr_i = (i_bit << n_bp | cgr_i) #Move previous kmer, append new one and use the mask to fix kmer-length
 *             cgr_j = (j_bit << n_bp | cgr_j)
 *             n_bp += 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 *             cgr_i >>= 1
 */
    __pyx_t_8 = ((__pyx_v_n_bp == __pyx_v_k) != 0);
    if (__pyx_t_8) {

      /* "idelucs/kmers.pyx":120
 * 
 *         if n_bp == k:
 *             CGR[(cgr_i << k) + cgr_j] += 1             # <<<<<<<<<<<<<<
 *             cgr_i >>= 1
 *             cgr_j >>= 1
 */
      __pyx_t_1 = ((__pyx_v_cgr_i << __pyx_v_k) + __pyx_v_cgr_j);
      *((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_CGR.data) + __pyx_t_1)) )) += 1;

      /* "idelucs/kmers.pyx":121
 *         if n_bp == k:
 *             CGR[(cgr_i << k) + cgr_j] += 1
 *             cgr_i >>= 1             # <<<<<<<<<<<<<<
 *             cgr_j >>= 1
 *             n_bp -= 1  #The other
 */
      __pyx_v_cgr_i = (__pyx_v_cgr_i >> 1);

      /* "idelucs/kmers.pyx":122
 *             CGR[(cgr_i << k) + cgr_j] += 1
 *             cgr_i >>= 1
 *             cgr_j >>= 1             # <<<<<<<<<<<<<<
 *             n_bp -= 1  #The other
 * 
 */
      __pyx_v_cgr_j = (__pyx_v_cgr_j >> 1);

      /* "idelucs/kmers.pyx":123
 *             cgr_i >>= 1
 *             cgr_j >>= 1
 *             n_bp -= 1  #The other             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_7idelucs_5kmers_3cgr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7idelucs_5kmers_2cgr[] = "cgr(unsigned char[::1] seq, int k, int[::1] CGR) -> void\n\n    seq is expected to be np.uint8 of bytevalues of the contig.\n    Only values  64, 67, 71, 84 (A, C, G, T) are accepted, all \n    others are skipped. The CGR vector  is expected to be an \n    array of 4^k 32-bit integers that when reshaped, should \n    show the fCGR\n    ";
static PyObject *__pyx_pw_7idelucs_5kmers_3cgr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_seq = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_k;
  __Pyx_memviewslice __pyx_v_CGR = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cgr (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_seq,&__pyx_n_s_k,&__pyx_n_s_CGR,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_k)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("cgr", 1, 3, 3, 1); __PYX_ERR(0, 53, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_CGR)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cgr", 1, 3, 3, 2); __PYX_ERR(0, 53, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cgr") < 0)) __PYX_ERR(0, 53, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_seq = __Pyx_PyObject_to_MemoryviewSlice_dc_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_seq.memview)) __PYX_ERR(0, 53, __pyx_L3_error)
    __pyx_v_k = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_k == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L3_error)
    __pyx_v_CGR = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_CGR.memview)) __PYX_ERR(0, 53, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cgr", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 53, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("idelucs.kmers.cgr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7idelucs_5kmers_2cgr(__pyx_self, __pyx_v_seq, __pyx_v_k, __pyx_v_CGR);
...
static PyObject *__pyx_pf_7idelucs_5kmers_2cgr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_seq, int __pyx_v_k, __Pyx_memviewslice __pyx_v_CGR) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("cgr", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_7idelucs_5kmers_cgr(__pyx_v_seq, __pyx_v_k, __pyx_v_CGR, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_seq, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_CGR, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "idelucs.kmers.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "idelucs.kmers._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"kmer_counts", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7idelucs_5kmers_1kmer_counts, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7idelucs_5kmers_kmer_counts},
  {"cgr", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7idelucs_5kmers_3cgr, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7idelucs_5kmers_2cgr},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_kmers(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_kmers},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initkmers(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initkmers(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_kmers(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_kmers(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_kmers(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'kmers' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_kmers(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("kmers", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "idelucs.kmers")) {
      if (unlikely(PyDict_SetItemString(modules, "idelucs.kmers", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init idelucs.kmers", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init idelucs.kmers");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
