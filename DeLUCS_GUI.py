...
class ResultsThread(QThread):
    ...
    def run(self):
        ...
        if len(self.model.predictions) <= 1:
            ...
            y_pred = label_features(predictions, self.model.n_clusters)            
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        pixmap = QPixmap('iDeLUCS_logo.png') #logo.png
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.input_optimizer.setItemText(1, _translate("MainWindow", "Adam"))
        self.input_optimizer.setItemText(2, _translate("MainWindow", "SGD"))
        self.input_optimizer.setItemText(0, _translate("MainWindow", "RMSprop"))
    ...
    def parse(self):
        ...
        self.args['optimizer'] = str(self.input_optimizer.currentText())
        self.args['batch_sz'] = int(self.input_batch_sz.text())
        ...
        self.args["lr"] = 1e-4  #5e-4
        self.args["model_size"] = "linear"  #5e-4
        self.args['scheduler']='Triangle'

        if self.args['sequence_file'] == "":
            QMessageBox.critical(self.centralwidget, "Error!", "Wowza! \n Please Select a Fasta File")

        elif self.args['weight'] > 1.0 or self.args['weight'] < 0.5:
            QMessageBox.critical(self.centralwidget, "Error!", "Training weight bust be in [0.5, 1.0]")
    ...
    def evt_show_results(self, info):
        ...
        if self.GT_fname:
            ...
            legend = self.display_results.axes.legend(*scatter.legend_elements(), title="Assignments", ncol=6) # , loc="lower left")
    ...
    def evt_update_progress(self, info):
        ...
        if self.training_plot[info["n_voters"]] is None:
            ...
            self.display_training.axes.set_ylim(self.training_loss[0]-1.5, self.training_loss[0]+1.5)
    ...
    def reset_to_default(self):
        ...
        self.input_batch_sz.setValue(512)
    ...
    def plot_UMAP(self):
        ...
        scatter = self.display_results.axes.scatter(self.embedded [:, 0], self.embedded [:, 1], s=4, c=self.assingments.astype(np.int32))
        self.display_results.axes.set_title('Latent Representation (UMAP)')
    ...
    def save_results_file(self):
        ...
        filename = f'{folder_name}/assignments.tsv'
        ...
        df.to_csv(f'{folder_name}/metrics.tsv',sep='\t')
